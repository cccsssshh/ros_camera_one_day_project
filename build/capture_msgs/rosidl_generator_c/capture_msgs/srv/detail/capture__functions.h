...
#ifndef CAPTURE_MSGS__SRV__DETAIL__CAPTURE__FUNCTIONS_H_
#define CAPTURE_MSGS__SRV__DETAIL__CAPTURE__FUNCTIONS_H_
...
#include "capture_msgs/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_capture_msgs
bool
 ...
 * calls
 * capture_msgs__srv__Capture_Request__init().
...
/**
 * It calls
 * capture_msgs__srv__Capture_Request__fini()
 ...
 * capture_msgs__srv__Capture_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * capture_msgs__srv__Capture_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * capture_msgs__srv__Capture_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_capture_msgs
...
/**
 * It calls
 * capture_msgs__srv__Capture_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_capture_msgs
...
/**
 * It allocates the memory for the array and calls
 * capture_msgs__srv__Capture_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_capture_msgs
...
/**
 * It calls
 * capture_msgs__srv__Capture_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CAPTURE_MSGS__SRV__DETAIL__CAPTURE__FUNCTIONS_H_
