...
#include "capture_msgs/srv/detail/capture__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = capture_msgs::srv::Capture_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const capture_msgs::srv::Capture_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<capture_msgs::srv::Capture_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_capture_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<capture_msgs::srv::Capture_Request>()
{
  return &capture_msgs::srv::typesupport_fastrtps_cpp::_Capture_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = capture_msgs::srv::Capture_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const capture_msgs::srv::Capture_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<capture_msgs::srv::Capture_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &capture_msgs::srv::typesupport_fastrtps_cpp::_Capture_Response__handle;
}
...
{
  return &capture_msgs::srv::typesupport_fastrtps_cpp::_Capture__handle;
}
