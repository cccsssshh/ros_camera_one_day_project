...
class Metaclass_Capture_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('capture_msgs')
        except ImportError:
            import logging
            import traceback
...
class Capture_Request(metaclass=Metaclass_Capture_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.filter_type = kwargs.get('filter_type', str())
    ...
    def filter_type(self, value):
        if __debug__:
            assert \
                ...
                "The 'filter_type' field must be of type 'str'"
...
class Metaclass_Capture(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from capture_msgs.srv import _capture
...
class Capture(metaclass=Metaclass_Capture):
    from capture_msgs.srv._capture import Capture_Request as Request
    from capture_msgs.srv._capture import Capture_Response as Response
