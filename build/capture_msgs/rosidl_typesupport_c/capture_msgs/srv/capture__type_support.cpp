...
static const _Capture_Request_type_support_symbol_names_t _Capture_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, capture_msgs, srv, Capture_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, capture_msgs, srv, Capture_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, capture_msgs, srv, Capture_Request)() {
  return &::capture_msgs::srv::rosidl_typesupport_c::Capture_Request_message_type_support_handle;
}
...
static const _Capture_Response_type_support_symbol_names_t _Capture_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, capture_msgs, srv, Capture_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, capture_msgs, srv, Capture_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, capture_msgs, srv, Capture_Response)() {
  return &::capture_msgs::srv::rosidl_typesupport_c::Capture_Response_message_type_support_handle;
}
...
static const _Capture_type_support_symbol_names_t _Capture_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, capture_msgs, srv, Capture)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, capture_msgs, srv, Capture)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, capture_msgs, srv, Capture)() {
  return &::capture_msgs::srv::rosidl_typesupport_c::Capture_service_type_support_handle;
}
